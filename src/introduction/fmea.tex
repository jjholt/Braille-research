...
The analysis of the parts of the device showed there are several potential hazards ranging from faulty batteries, with a risk priority score of 64 out of 125, to character pins not retracting properly with a score of 0/125. 

The solutions that need to take place for these potential issues are summarised in the table below. 
...
\newgeometry{left=0.3cm,right=0.3cm}
    \begin{table}[!ht] \rowcolors{2}{gray!25}{white}
        \centering
    ...
    \end{table}
    \clearpage
    \begin{table}\rowcolors{2}{gray!25}{white}
        \centering
        \begin{tabular}{b{1.7cm} b{2cm} b{2.5cm} b{4cm}l b{6cm}}
            % \rowcolor{gray!40}
            \textbf{Category} & \textbf{Part name} & \textbf{Failure Mode} & \textbf{Mechanism \& Cause of failure} & \textbf{PRA} & \textbf{Recommended Corrective Action} \\ \hline
